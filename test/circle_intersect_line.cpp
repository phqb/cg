...
int circle_intersect_line() {
    ...
    for (long test = 0; test < 1000000; ++test) {
        cg::Circle c(cg::Point(utils.randFloat(1000), utils.randFloat(1000)), fabs(utils.randFloat(1000)));
        cg::Line l(cg::Point(utils.randFloat(1000), utils.randFloat(1000)), cg::Point(utils.randFloat(1000), utils.randFloat(1000)));
