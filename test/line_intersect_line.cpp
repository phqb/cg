...
int line_intersect_line() {
    ...
    for (long test = 0; test < 1000000; ++test) {
        {
            cg::Line line_a(cg::Point(utils.randFloat(1000), utils.randFloat(1000)), cg::Point(utils.randFloat(1000), utils.randFloat(1000)));
            cg::Line line_b(-line_a.b, line_a.a, utils.randFloat(1000));
        ...
        {
            cg::Line line_a(cg::Point(utils.randFloat(1000), utils.randFloat(1000)), cg::Point(utils.randFloat(1000), utils.randFloat(1000)));
            cg::Line line_b(line_a.a, line_a.b, line_a.c + utils.randFloat(1000));
            auto inter = line_a.intersect(line_b);
            if (inter.first) {
                printf("Failed at test:\n");
                line_a.show();
