...
int point_in_halfplane() {
    ...
    for (int test = 0; test < 1000000; ++test) {
        ...
        cg::HalfPlane hl1(cg::Point_2(utils.randFloat(1000), utils.randFloat(1000)), cg::Point_2(utils.randFloat(1000), utils.randFloat(1000)), side);
        cg::HalfPlane hl2(hl1.a, hl1.b, hl1.c, -side);
        cg::Point_2 p(utils.randFloat(1000), utils.randFloat(1000));
